...
def build_model(input_shape):
    ...
    outputs = Dense(24)(flattened)  # Output layer now predicts 24 time steps
...
def train_model():
    ...
    X, y, scaler = create_sequences(data, forecast_horizon=24)
...
if __name__ == "__main__":
    socketio.run(app, host="192.168.1.143", port=5100, debug=True)
