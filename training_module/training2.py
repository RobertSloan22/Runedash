...
def check_status():
    ...
    container_name = "your_training_container_name"  # Replace with your container name
...
if __name__ == "__main__":
    socketio.run(app, host="0.0.0.0", port=5250, debug=True, allow_unsafe_werkzeug=True)
