...
const Forecast2 = () => {
  ...
  const fetchStatusData = async () => {
    try {
      const response = await axios.get('https://99.37.183.149:3055/api4/forecastingstatus', {
        headers: {
  ...
  const fetchImage = async () => {
    try {
      const response = await axios.get('https://99.37.183.149:3055/api4/forecastplot', {
        responseType: 'blob',
      });
