...
import LineChartComponent from './LineChart'; // Import the LineChart component
import { ForecastDataContext } from '../context/ForecastDataContext'; // Import the AreaChart component
...
const DualLineChart = () => {
  ...
  useEffect(() => {
    const fetchForecastData = async () => {
      try {
        ...
        const forecastResponse = await axios.get('http://localhost:4650/api5/predictions'); // Replace with your actual endpoint
  ...
  return (
    <div>
      <h2>Historical Price-Sats / Forecasted Price-Sats</h2>
