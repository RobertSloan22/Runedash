...
import ThreeDDonutChart from './Three';
import './app.css';

const endpoints = [
 
  { name: '3055-Base', endpoint: 'http://localhost:3055/health' },
  { name: '3055ForecastStatus', endpoint: 'http://localhost:3055/api4/forecastingstatus' },
  { name: '3055FPLOT', endpoint: 'http://localhost:3055/api4/forecastplot' },
  { name: 'BDC-4650', endpoint: 'http://localhost:4560/api5/predictions' },
  { name: 'RuneForecastGeneratior', endpoint: 'http://localhost:4650/health' },
  { name: 'NeuralNetTraining', endpoint: 'http://localhost:5100/health' },
