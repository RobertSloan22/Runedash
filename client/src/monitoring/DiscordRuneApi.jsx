...
const endpoints = [
    { name: 'DiscordAPI', endpoint: 'http://localhost:5550/status' },
    { name: 'Discordhealth', endpoint: 'http://localhost:5550/health' },

    { name: 'RuneAPI', endpoint: 'http://localhost:5540/status' },
    { name: 'Runehealth', endpoint: 'http://localhost:5540/health' },
