      ...
      <div style={{ width: '100%', height: '400px' }}>
        ...
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            <Tooltip />
            <Legend />
            <Area type="monotone" dataKey="prediction" stroke="#000" fill="url(#splitColor)"  name="Forecasted Price" />
            <Area type="monotone" data={filteredHistoricalData} dataKey="actual" stroke="#82ca9d" name="Actual Price" />
          </AreaChart>
        </ResponsiveContainer>
      </div>
    </div>
